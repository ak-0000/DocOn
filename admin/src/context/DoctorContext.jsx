...
const DoctorContextProvider = (props) => {
  ...
  const getAppointments = sync() => {
   ...
   const cancelAppointment = async(appointmentId) => {
    try {
      const {data}  = await axios.post(backend_url + '/api/doctor/cancelled-appointment' , {appointmentId} , {headers :{dToken}})
  ...
  const value = {
    dToken,setDToken,backend_url,appointments , setAppointments , getAppointments , cancelAppointment , completeAppointment , getDashData , setDashData , dashData,profileData , setProfileData , getProfileData
  };
